...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Ended = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Analytics = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameLogic = (function () {
	  ...
	  _createClass(GameLogic, null, [{
	    ...
	    key: '_random24',
	    value: function _random24(mixer) {
	      var percent = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];

	      var mixR = 128;
	      var mixG = 128;
	      var mixB = 128;
	      var mixerR = mixer ? mixer >> 16 : 0;
	      var mixerG = mixer ? (mixer >> 8) % 256 : 0;
	      var mixerB = mixer ? mixer % 256 : 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _dep.alt.createStore(Analytics, 'Analytics');
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = (function (_React$Component) {
	  ...
	  _createClass(Game, [{
	    ...
	    key: '_handleHovering',
	    value: function _handleHovering(i, on) {
	      if (!on) {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('div', { className: 'box background-fade', style: { background: this._intToHexColor(this.state.colorB) } }),
	        _react2['default'].createElement(
	          'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ended = (function (_React$Component) {
	  ...
	  _createClass(Ended, [{
	    ...
	    key: 'handleFbShare',
	    value: function handleFbShare() {
	      var message = ('I scored ' + this.props.gameStore.score + ' points at COLOR+, a game where you guess a combination of colors! #colorplus').toString();
	      // const w = 600;
	      // const h = 300;
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'a',
	            { onClick: this.handleFbShare.bind(this),
	              target: '_blank' },
	            'Share on Facebook'
	          )
	        )
