...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddons = __webpack_require__(188);
	...
	(function () {
	  _actions2['default'].App.init();
	  _reactAddons2['default'].render(_reactAddons2['default'].createElement(_views2['default'].App, null), document.body);
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dep = __webpack_require__(160);
	...
	var _Ended = __webpack_require__(187);
	...
	var App = (function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    this.state = {
	      appStore: _dep.Stores.App.getState(),
	      gameStore: _dep.Stores.Game.getState()
	    };
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      _dep.Stores.App.listen(this._handleAppStore);
	      _dep.Stores.Game.listen(this._handleGameStore);
	    }
	  }, {
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      _dep.Stores.App.unlisten(this._handleAppStore);
	      _dep.Stores.Game.unlisten(this._handleGameStore);
	    }
	  }, {
	    key: '_handleAppStore',
	    value: function _handleAppStore(data) {
	    ...
	    value: function _handleStartGame() {
	      _dep.Actions.App.startGame();
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'container' },
	          _react2['default'].createElement(_Game2['default'], { enabled: this.state.appStore.appState === 'STARTED' }),
	          this.state.appStore.appState === 'ENDED' ? _react2['default'].createElement(_Ended2['default'], { gameStore: this.state.gameStore }) : null
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dep = __webpack_require__(163);
	...
	var App = (function () {
	  function App() {
	    ...
	    this.bindListeners({
	      onInit: _dep.Actions.App.init,
	      onStartGame: _dep.Actions.App.startGame,
	      onEndGame: _dep.Actions.Game.endGame,
	      onNewHighScore: _dep.Actions.App.newHighScore
	    });
	  ...
	  _createClass(App, [{
	    ...
	    key: 'onNewHighScore',
	    value: function onNewHighScore(highScore) {
	...
	exports['default'] = _dep.alt.createStore(App, 'App');
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStateFunctions = __webpack_require__(175);
	...
	var _utilsAltUtils = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dep = __webpack_require__(179);
	...
	var App = (function () {
	  ...
	  _createClass(App, [{
	    ...
	    value: function startGame() {
	      this.dispatch(_dep.GameLogic.startGame());
	    }
	  }, {
	    key: 'newHighScore',
	    value: function newHighScore(highScore) {
	...
	exports['default'] = _dep.alt.createActions(App);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameLogic = __webpack_require__(180);

	var _gameLogic2 = _interopRequireDefault(_gameLogic);

	exports['default'] = {
	  alt: _alt2['default'],
	  GameLogic: _gameLogic2['default']
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameLogic = __webpack_require__(181);

	var _gameLogic2 = _interopRequireDefault(_gameLogic);

	exports['default'] = _gameLogic2['default'];
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameLogic = (function () {
	  ...
	  _createClass(GameLogic, null, [{
	    ...
	    key: 'isCorrectColor',
	    value: function isCorrectColor(colorA, colorB, chosen) {
	      return chosen === GameLogic.colorAverage(colorA, colorB);
	    }
	  }, {
	    key: 'colorAverage',
	    value: function colorAverage(a, b) {
	      var blue = Math.floor((a % 256 + b % 256) / 2);
	      a = a >> 8;
	      b = b >> 8;
	      var green = Math.floor((a % 256 + b % 256) / 2);
	      a = a >> 8;
	      b = b >> 8;
	      var red = Math.floor((a % 256 + b % 256) / 2);
	    ...
	    value: function nextRound() {
	      ...
	      var msLeft = Math.max(15000 - 1000 * (prevRound.score + 1), 2000);
	      var round = {
	    ...
	    key: '_random24',
	    value: function _random24() {
	      var mixR = 160;
	      var mixG = 128;
	      var mixB = 128;
	      var red = Math.floor(Math.pow(2, 8) * Math.random());
	      var green = Math.floor(Math.pow(2, 8) * Math.random());
	      var blue = Math.floor(Math.pow(2, 8) * Math.random());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = (function () {
	  ...
	  _createClass(Game, [{
	    ...
	    key: 'decrementTime',
	    value: function decrementTime(time) {
	      this.dispatch(time);

	      if (_dep.alt.stores.Game.state.msLeft - time < 0) {
	...
	exports['default'] = _dep.alt.createActions(Game);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = (function () {
	  ...
	  _createClass(Game, [{
	    key: 'onStartGame',
	    value: function onStartGame(round) {
	      this.setState(round);
	    }
	  }, {
	    key: 'onDecrementTime',
	    value: function onDecrementTime(time) {
	      this.setState({
	...
	exports['default'] = _dep.alt.createStore(Game, 'Game');
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = (function (_React$Component) {
	  ...
	  function Game(props) {
	    ...
	    this.state = _dep.Stores.Game.getState();

	    var greyRGB = (127 << 16) + (127 << 8) + 127;
	  ...
	  _createClass(Game, [{
	    ...
	    key: '_intToHexColor',
	    value: function _intToHexColor(d) {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement('div', { className: 'box', style: { background: this._intToHexColor(this.state.colorA) } }),
	        _react2['default'].createElement(
	          'div',
	          { className: 'symbol plus' },
	          '+'
	        ),
	        _react2['default'].createElement('div', { className: 'box', style: { background: this._intToHexColor(this.state.colorB) } }),
	        _react2['default'].createElement(
	          'div',
	          { className: 'symbol equals' },
	          '='
	        ),
	        this.state.options.map(function (color, i) {
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Header, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'span',
	          { className: 'title', style: { color: '#E74C3C' } },
	          'C'
	        ),
	        _react2['default'].createElement(
	          'span',
	          { className: 'title', style: { color: '#16A085' } },
	          'O'
	        ),
	        _react2['default'].createElement(
	          'span',
	          { className: 'title', style: { color: '#F39C12' } },
	          'L'
	        ),
	        _react2['default'].createElement(
	          'span',
	          { className: 'title', style: { color: '#8E44AD' } },
	          'O'
	        ),
	        _react2['default'].createElement(
	          'span',
	          { className: 'title', style: { color: '#3498DB' } },
	          'R'
	        ),
	        _react2['default'].createElement(
	          'span',
	          { className: 'title', style: { color: '#34495E' } },
	          '+'
	        ),
	        _react2['default'].createElement(
	          'div',
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'p',
	              { className: 'score-amt' },
	              Math.max(this.props.appStore.highScore || 0, this.props.gameStore.score || 0)
	            )
	          )
	        ),
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'a',
	            { onClick: _dep.Actions.App.startGame },
	            'New Game'
	          )
	        )
	      );
	...
	Header.propTypes = {
	  appStore: _react2['default'].PropTypes.object,
	  gameStore: _react2['default'].PropTypes.object
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ended = (function (_React$Component) {
	  _inherits(Ended, _React$Component);

	  function Ended() {
	    _classCallCheck(this, Ended);

	    _get(Object.getPrototypeOf(Ended.prototype), 'constructor', this).apply(this, arguments);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinkedStateMixin = __webpack_require__(190);
	...
	var cx = __webpack_require__(203);
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  React.addons.TestUtils = __webpack_require__(205);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLink = __webpack_require__(191);
	var ReactStateSetters = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(14);
	var ReactPropTransferer = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?sourceMap!./app.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?sourceMap!./app.scss");
